...
## MVP Excludes Payment UI
The MVP of this repository explicitly ships without any payment UI elements or functionalities. Automated tests enforce this policy by scanning for any payment-related artifacts and routes.
